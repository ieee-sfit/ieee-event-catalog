const overlay = document.querySelector('.overlay');
        ...
        function setCanvasSize() {
            ...
            canvas.height = window.innerHeight;// ... rest of your code

            // Close full-panel when clicking on the canvas
            canvas.addEventListener('click', () => {
                ...
                fullPanel.classList.remove('active');
                container.style.pointerEvents = 'auto'; // Re-enable clicks on cards
            });
        }
        ...
        class Star {
            ...
            update() {
                this.z -= speed * (1.5 - this.z / maxDepth);
                if (this.z <= 0) {
                    this.reset();
                }
            }
